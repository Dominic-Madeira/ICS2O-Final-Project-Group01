...
class GameScene extends Phaser.Scene {
  ...
  birdJump() {
    ...
    if (keySpaceObj.isDown === false && mouseClick.isDown === false) {
      this.jump = false
    }
  }
  ...
  endGame() {
    ...
    if (this.score >= 10 && this.score < 19) {
      this.bronzeMedal = this.add.sprite(
        1920 / 2 - 184,
        1080 / 2 + 20,
        "bronzeMedal"
      )
      ...
      this.silverMedal = this.add.sprite(
        1920 / 2 - 184,
        1080 / 2 + 20,
        "silverMedal"
      )
      ...
      this.goldMedal = this.add.sprite(
        1920 / 2 - 184,
        1080 / 2 + 20,
        "goldMedal"
      )
